...
export const fetchCMSData = async (
  ...
  const translations = {
    ...
    ko: {
      ...
      hugoDescription:
        "클래식 휴고 칵테일의 상쾌한 변형으로, 시빌라의 스파클링 마법과 신선한 민트 잎으로 강화되었습니다.",
      spritzDescription:
        "이탈리안 아페리티보의 완벽함. 시빌라와 아페롤이 만나 이탈리아 여름의 정신을 구현하는 생생하고 거품이 나는 칵테일입니다.",
      sbagliatoDescription:
        "네그로니 스바글리아토의 세련된 재해석으로, 시빌라가 전통적인 프로세코를 대체하여 향상된 경험을 제공합니다.",
      sojuFizzDescription:
    ...
    recipes: [
      {
        ...
        title: "HUGO",
        image:
          "https://images.pexels.com/photos/9042566/pexels-photo-9042566.jpeg",
      ...
      },
      {
        ...
        title: "SBAGLIATO",
        image:
          "https://images.pexels.com/photos/6989843/pexels-photo-6989843.jpeg",
      ...
      },
      {
        ...
        title: "SOJU FIZZ",
        image:
          "https://images.pexels.com/photos/7826343/pexels-photo-7826343.jpeg",
