        ...
        {instructionsData.map((instruction, index) => (
          ...
          >
            ...
            >
              ...
              >
                <motion.div
                  className="instruction-image relative h-80 sm:h-96 md:h-[500px] overflow-hidden group"
                  whileHover={{
                ...
                >
                    ...
                    animate={
                      instruction.step === 1 && shouldAnimateStep1
                        ...
                        : instruction.step === 2 && shouldAnimateStep2
                          ? {
                              // Ultra harmonious shake animation - mobile optimized
                              x: [0, -3, 3, -2, 2, -1, 1, 0],
                              y: [0, -1.5, 1.5, -1, 1, -0.5, 0.5, 0],
                              rotate: [0, -0.5, 0.5, -0.3, 0.3, -0.1, 0.1, 0],
                              scale:
                                window.innerWidth < 768
                                  ? [1.2, 1.202, 1.198, 1.201, 1.199, 1.2]
                                  : [1.5, 1.502, 1.498, 1.501, 1.499, 1.5],
                            }
                  ...
                  {instruction.step === 2 && shouldAnimateStep2 && (
                    <div className="absolute inset-0 pointer-events-none">
                      {/* Enhanced shake glitter particles */}
