        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="w-48 h-48 mx-auto bg-brand-black p-4 rounded-lg relative overflow-hidden">
                {/* QR Code Pattern */}
                <div className="w-full h-full bg-brand-white grid grid-cols-8 gap-1 p-2 rounded">
                  {Array.from({ length: 64 }).map((_, i) => (
                    <motion.div
                      ...
                      className="bg-brand-black rounded-sm"
                    />
                  ))}
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-8 h-8 bg-brand-white rounded flex items-center justify-center">
                    <QrCode size={20} className="text-brand-black" />
                  </div>
                </div>
