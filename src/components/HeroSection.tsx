...
export function HeroSection({ productData }: HeroSectionProps) {
  ...
  return (
    ...
    >
      {/* Vertical Side Text - only in hero section, hidden on mobile */}
      <div className="absolute inset-0 z-10 pointer-events-none hidden md:block">
        {/* Left side text */}
        <div className="absolute left-4 lg:left-8 top-1/2 -translate-y-1/2">
          <div
            className="text-xs lg:text-sm font-light tracking-[0.2em] text-black/70 space-y-8"
        ...
        <div className="absolute right-4 lg:right-8 top-1/2 -translate-y-1/2">
          <div
            className="text-xs lg:text-sm font-light tracking-[0.2em] text-black/70"
            style={{ writingMode: "vertical-rl", textOrientation: "mixed" }}
          >
            <motion.div
              initial={{ opacity: 0, x: 20 }}
      ...
      >
        ...
        >
          <div
            ref={bottleRef}
            className="relative w-64 h-[400px] sm:w-80 sm:h-[500px] md:w-96 md:h-[600px] lg:w-[450px] lg:h-[700px]"
          >
            <motion.img
